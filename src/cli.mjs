// cli.mjs — Runs the orchestrator + verifier + writes the canonical stream.
...
const OUT_STREAM = resolve(HERE, "../examples/stratos-guardianai-reference-stream.ndjson");
...
console.log(`OK · ${events.length} events · chain ✓ · 3 invariants ✓ (cui-distribution-statement + itar-us-person + dfars-72-hour)`);
